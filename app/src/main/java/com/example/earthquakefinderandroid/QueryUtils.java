    ...
    public static ArrayList<Earthquake> extractEarthquakes(String SAMPLE_JSON_RESPONSE) {
        ...
        try {
            ...
            for (int i=0;i<jsonArray.length();i++){
                JSONObject currEar = jsonArray.getJSONObject(i);
                JSONObject prop = currEar.getJSONObject("properties");
                ...
                Earthquake earthquake = new Earthquake(mag,loc,dateToDisplay);
